      ...
      <header className="fixed w-full top-0 z-50">
        ...
        <div className="relative container mx-auto px-4">
          <div className="flex items-center justify-between h-[80px]">
            ...
            {/* Search Button - Matching sharp design */}
            <motion.button
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => setIsSearchOpen(true)}
              className="hidden md:flex items-center h-[40px] px-6 relative group"
            >
            ...
            >
              ...
              >
                ...
                {/* Content */}
                <div className="relative z-10 h-full flex items-center gap-2 text-gray-400 group-hover:text-white transition-colors">
