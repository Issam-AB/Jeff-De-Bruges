...
export default function ImageUpload({ mainImage, gallery, onImagesUpdated }: ImageUploadProps) {
  ...
  return (
    <div className="space-y-4">
      {/* Main Image */}
      <div>
        <label className="block text-sm font-medium mb-2 text-white">Main Image</label>
      ...
      {/* Gallery */}
      <div>
        <label className="block text-sm font-medium mb-2 text-white">Gallery Images</label>
