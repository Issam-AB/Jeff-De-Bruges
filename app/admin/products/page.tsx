...
export default function ProductsPage() {
  ...
  const categories = ['all', ...PREDEFINED_CATEGORIES.map(cat => cat.id)]
  ...
  const filteredProducts = products.filter(product => {
    ...
    const matchesCategory = (() => {
      ...
      // Find the category by ID and compare with the product's mainCategory
      const categoryData = PREDEFINED_CATEGORIES.find(cat => cat.id === selectedCategory)
      return categoryData ? product.mainCategory === categoryData.name : false
    })()
          ...
          <Select value={selectedCategory} onValueChange={setSelectedCategory}>
            ...
            <SelectContent className="bg-white">
              {categories.map(category => {
                ...
                const categoryData = PREDEFINED_CATEGORIES.find(cat => cat.id === category)
                return (
                  <SelectItem key={category} value={category}>
