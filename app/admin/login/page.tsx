  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] to-[#1e3a8a] relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        <div className="absolute top-[20%] left-[15%] w-72 h-72 bg-red-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-[20%] right-[15%] w-96 h-96 bg-red-500/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 bg-white/10 backdrop-blur-xl p-10 rounded-3xl shadow-2xl w-full max-w-md border border-white/10">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-white/70 text-sm">
            Bienvenue sur le panneau d'administration. Entrez votre mot de passe pour gérer les produits.
          </p>
        </div>
